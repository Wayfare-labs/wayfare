...
const CASES = [
  ...
  { group: "documented", name: "chain-heads", method: "GET", path: "/api/chain-heads", expect: { status: 200 },
    note: "docs/api.md: publishes the current hash, sequence and timestamp for each stored corridor." },
  ...
  { group: "documented", name: "chain-heads-pretty", method: "GET", path: "/api/chain-heads?pretty=1", expect: { status: 200 },
    note: "docs/api.md: pretty=1 indents the chain-head JSON." },
  ...
  { group: "method", name: "post-assets", method: "POST", path: "/api/assets", expect: UNSUPPORTED_METHOD,
    note: "docs/api.md: unsupported methods return 405." },
  { group: "method", name: "post-chain-heads", method: "POST", path: "/api/chain-heads", expect: { status: 405, code: "method_not_allowed" },
    note: "The published chain head is read-only." },
  ...
  { group: "error", name: "chain-heads-unknown-param", method: "GET", path: "/api/chain-heads?foo=1", expect: { status: 400, code: "invalid_query" },
    note: "/api/chain-heads accepts no parameters other than pretty." },
